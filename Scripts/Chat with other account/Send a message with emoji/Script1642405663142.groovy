...
WebUI.click(findTestObject('Object Repository/Page_Element  nchhuy19/div'))

WebUI.setText(findTestObject('Object Repository/Page_Element  nchhuy19/div_hi'), '<div style="">hi </div>')

WebUI.click(findTestObject('Object Repository/Page_Element  nchhuy19/div_hi_mx_AccessibleButton mx_MessageCompos_a1b40b'))

WebUI.click(findTestObject('Object Repository/Page_Element  nchhuy19/div_'))

WebUI.click(findTestObject('Object Repository/Page_Element  nchhuy19/div_This room is public_mx_ContextualMenu_b_fc4f75'))

WebUI.click(findTestObject('Object Repository/Page_Element  nchhuy19/div_hi_mx_AccessibleButton mx_MessageCompos_cccf2b'))
