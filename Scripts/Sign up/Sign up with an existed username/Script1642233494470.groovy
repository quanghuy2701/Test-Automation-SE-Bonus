...
WebUI.setText(findTestObject('Object Repository/Page_Element/input_Or_mx_RegistrationForm_username'), 'bqhuy19')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Element/input_Username_mx_RegistrationForm_password'), 'hk4lGgMz64ADmWBUEkMbyw==')
...
WebUI.click(findTestObject('Object Repository/Page_Element/input_Or_mx_RegistrationForm_username'))
