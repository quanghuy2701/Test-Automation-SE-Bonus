...
WebUI.click(findTestObject('Object Repository/Page_Element  Matrix HQ/div_Matrix HQ_mx_RoomHeader_chevron'))

WebUI.click(findTestObject('Object Repository/Page_Element  Matrix HQ/span_Files'))
