...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_Element/input_Security Key_mx_securityKey'), 'JkYzbGlbK9joeG/gfPh1hMx/ll6VA4gF+6lbBvcccyo4+x1BvpuHzw==')

WebUI.click(findTestObject('Object Repository/Page_Element/div_Security KeyUse your Security Key to co_ef0ab1'))
