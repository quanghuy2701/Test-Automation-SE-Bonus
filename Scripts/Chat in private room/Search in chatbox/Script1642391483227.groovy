...
WebUI.click(findTestObject('Object Repository/Page_Element  Chat room/div_Chat room_mx_AccessibleButton mx_RoomHe_38521f'))

WebUI.setText(findTestObject('Object Repository/Page_Element  Chat room/input_All Rooms_focus-visible'), 'unable')

WebUI.sendKeys(findTestObject('Object Repository/Page_Element  Chat room/input_All Rooms_focus-visible'), Keys.chord(Keys.ENTER))
