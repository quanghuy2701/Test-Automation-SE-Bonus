...
WebUI.click(findTestObject('Object Repository/Page_Element  Chat room/div__mx_AccessibleButton mx_MessageComposer_717fb8'))

WebUI.click(findTestObject('Object Repository/Page_Element  Chat room/div_'))
