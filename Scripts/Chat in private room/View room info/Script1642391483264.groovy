...
WebUI.click(findTestObject('Object Repository/Page_Element  Chat room/div_Chat room_mx_AccessibleButton mx_RightP_44bbd4'))

WebUI.click(findTestObject('Object Repository/Page_Element  Chat room/div_ok_mx_AccessibleButton mx_BaseCard_close'))
