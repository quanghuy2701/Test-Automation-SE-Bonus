...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_Element 1/input_Security Key_mx_securityKey'), 'AM89fC/Z2L+0kQrgUJMoihakSLfqExGqqEDegROy7UCQVs01BySrESr2vAK0g5sjPD354BYtGaX7vGUm05HO7A==')
...
WebUI.click(findTestObject('Object Repository/Page_Element 1/div_Chat roomChat room'))

WebUI.click(findTestObject('Object Repository/Page_Element 1  Chat roomChat room/div_Error processing voice message_mx_Acces_8433cb'))

WebUI.click(findTestObject('Object Repository/Page_Element 1  Chat roomChat room/div_Error processing voice message_mx_Acces_a7d166'))
