...
WebUI.click(findTestObject('Object Repository/Page_Element/h3_Private'))

WebUI.click(findTestObject('Object Repository/Page_Element/div_Create'))

WebUI.click(findTestObject('Object Repository/Page_Element/div_Your private spaceAdd some details to h_395764'))

WebUI.click(findTestObject('Object Repository/Page_Element/div_Create a Group Chat_mx_ContextualMenu_b_ec9165'))
