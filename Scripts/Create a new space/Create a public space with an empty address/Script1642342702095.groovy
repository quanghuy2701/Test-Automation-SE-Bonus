...
WebUI.setText(findTestObject('Object Repository/Page_Element/input_Upload_spaceName'), 'quanghuy123')

WebUI.click(findTestObject('Object Repository/Page_Element/div_Your public spaceAdd some details to he_7d9a67'))
